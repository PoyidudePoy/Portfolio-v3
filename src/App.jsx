      ...
      <div className="bg-vintage p-4 font-chakra-petch font-extrabold">
        <div className="text-center text-4xl pt-10 md:text-5xl  ">
          ...
          <div className="grid grid-cols-12 mt-8 lg:p-5 lg:w-3/4 lg:justify-self-center ">
            <div className="col-span-12 p-4 md:p-4 md:col-start-2 md:col-end-12  lg:col-start-1 lg:col-end-7 lg:w-auto" >
          ...
          <div className="col-span-12 p-4 md:col-start-2 md:col-end-12 md:p-4 lg:col-start-7 lg:col-end-13 lg:w-auto">
      ...
      <div id="projects" className="text-xl font-chakra-petch font-extrabold p-6 bg-beige md:pt-15 lg:p-20 ">
         <div className="text-4xl p-4 pl-0 text-left md:text-6xl">My Works 🪬</div>
          ...
          <div className="grid grid-cols-12">
            <div className="col-span-12 p-4 border-5 rounded-xl md:col-span-6 lg:col-span-4">
